...
test.describe("Offline Map Capabilities", () => {
    ...
    test("Should cache map tiles and display them when offline", async ({ page, context }) => {
        ...
        // ✅ FIX: Grant geolocation permissions to prevent 5s timeout/hang in getCurrentPosition
        ...
        // Wait longer than default 5s because geolocation might still take a moment or async rendering
